...
%% ---- Figure 2: Ridge plot of projection distributions ----
\begin{figure}[t]
\centering
\includegraphics[width=0.9\textwidth]{fig2_ridge_projections.png}
\caption{\textbf{Distribution of global mean sea-level projections under SSP2-4.5.}
Probability densities at 2040, 2060, 2080, and 2100 for the composite forecast
(blue), satellite-era quadratic extrapolation (grey), and IPCC AR6 process-model
projections (red). Dashed lines indicate medians. Lower axes show the
corresponding number of additional people on land below flood level
\citep{Kulp2019} and global annual flood costs \citep{Jevrejeva2018}, both
assuming no additional coastal adaptation.}
\label{fig:ridge_projections}
\end{figure}

%% ---- Figure 3: Per-component breakdown ----
%\begin{figure}[t]
%\centering
