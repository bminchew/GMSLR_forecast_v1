...
quadratic extrapolation (grey dashed) and GMST (red, 10-year smooth;
Berkeley Earth \cite{Rohde2020}) on the right axis.  GMSL has risen
21~cm (19--23~cm, 90\% CI) since 1900, with the rate doubling from
1.1~mm\,yr$^{-1}$ (0.8--1.3~mm\,yr$^{-1}$) averaged over 1900--1940 to
2.2~mm\,yr$^{-1}$ (1.2--3.2~mm\,yr$^{-1}$) in 1995, then doubling again to
4.5~mm\,yr$^{-1}$ (3.5--5.5~mm\,yr$^{-1}$) by 2024
\citep{Hamlington2024, Rohde2020}.
\textbf{(b)}~GMSL rate (blue; kinematics from Frederikse and NASA)
and GMST (red) on shared time axis, with the quadratic rate extrapolation
(grey dashed).
\textbf{(c)}~GMSL rate versus GMST anomaly.  Observations (circles,
colored by year) and the Bayesian rate-and-state semi-empirical model
(squares, colored by instantaneous sensitivity
$\alpha = d\dot{H}/dT$).  The nonlinear rate--temperature relationship
explains the accelerating rate doublings observed in~(a--b).}
