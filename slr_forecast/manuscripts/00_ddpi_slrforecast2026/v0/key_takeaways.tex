...
The forecasting literature, developed across economics, meteorology, epidemiology, and supply chain management, has established that increasing model complexity beyond the information content of the calibration data degrades out-of-sample skill \citep{Green2015}. Forecast combinations outperform individual methods \citep{Makridakis2018}. Model skill must be demonstrated through out-of-sample validation, not in-sample fit.
