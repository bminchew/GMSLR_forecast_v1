...
\textbf{(a)} Sum of components used for the budget-closure comparison (excluding EAIS; see text) against NASA satellite altimetry (grey); shaded band is the 5--95\% Monte Carlo range.
\textbf{(b)} Stacked per-component contributions to the hindcast, including EAIS; the black line is their sum.
All values are relative to the year 2000 baseline.}
