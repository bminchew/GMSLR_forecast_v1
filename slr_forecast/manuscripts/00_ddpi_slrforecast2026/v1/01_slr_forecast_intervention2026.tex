...
%We fit a two-layer model jointly to NOAA in situ thermosteric sea level at 0--700\,m (1955--2025, 71 annual points) and 0--2000\,m (2005--2025, 21 points) \citep{Levitus2012}. The relaxation time of the upper later, $\tau_u$, has a weakly informative prior, $\log\tau_u \sim \mathcal{N}(\log 8,0.5^2)$, consistent with the range in \citet{Geoffroy2013}. The other five parameters --- $a$, $b_u$, $b_d$, $c$, and $\sigma_{\mathrm{extra}}$ --- get uninformative flat priors with wide bounds (Fig. \ref{fig:ocean_priors_posteriors}). $\sigma_{\mathrm{extra}}$ is a noise term, shared across both the 0--700\,m and 0--2000\,m records, that absorbs misfit beyond the reported observational error. The six free parameters are sampled via MCMC (using package emcee with 64 walkers, 6000 burn-in steps, and 30000 production steps to ensure convergence). The posterior median and 90\% credible intervals are: $a = 20.0$~[10.1, 31.2]~mm\,$^\circ$C$^{-2}$, $b_u = 51.0$~[40.6, 75.4]~mm $^\circ$C$^{-1}$, $b_d = 68.6$~[37.0, 104.3]~mm\,$^\circ$C$^{-1}$, $c = 0.023$~[$-0.112$, 0.140] mm yr$^{-1}$, $\tau_u = 11.6$~[6.2, 25.3]~yr, and $\sigma_{\mathrm{extra}} = 2.0$~[1.7, 2.3]~mm. The calibrated model reproduces both records with RMS residuals of 2.3~mm for depths 0--700 m and 1.3~mm for 0--2000 m, against 42 and 30 mm of observed rise over the respective records.
