...
# ISMIP6 experiment descriptions (Seroussi et al., 2020, Table 1; Nowicki et al., 2020).
# All exp* runs are forced by CMIP5 AOGCMs.
ISMIP6_EXPERIMENTS = {
    ...
    'exp01': 'NorESM1-M RCP8.5, medium melt (open)',
    'exp02': 'MIROC-ESM-CHEM RCP8.5, medium melt (open)',
    'exp03': 'NorESM1-M RCP2.6, medium melt (open)',
    'exp04': 'CCSM4 RCP8.5, medium melt (open)',
    'exp05': 'NorESM1-M RCP8.5, medium melt (std)',
    'exp06': 'MIROC-ESM-CHEM RCP8.5, medium melt (std)',
    'exp07': 'NorESM1-M RCP2.6, medium melt (std)',
    'exp08': 'CCSM4 RCP8.5, medium melt (std)',
    'exp09': 'NorESM1-M RCP8.5, high melt (std)',
    'exp10': 'NorESM1-M RCP8.5, low melt (std)',
    'exp11': 'CCSM4 RCP8.5, medium melt, ice-shelf collapse (open)',
    'exp12': 'CCSM4 RCP8.5, medium melt, ice-shelf collapse (std)',
    'exp13': 'NorESM1-M RCP8.5, PIGL melt (std)',
    'expA1': 'HadGEM2-ES RCP8.5, medium melt (open)',
    'expA2': 'CSIRO-MK3 RCP8.5, medium melt (open)',
    'expA3': 'IPSL-CM5A-MR RCP8.5, medium melt (open)',
    'expA4': 'IPSL-CM5A-MR RCP2.6, medium melt (open)',
    'expA5': 'HadGEM2-ES RCP8.5, medium melt (std)',
    'expA6': 'CSIRO-MK3 RCP8.5, medium melt (std)',
    'expA7': 'IPSL-CM5A-MR RCP8.5, medium melt (std)',
    'expA8': 'IPSL-CM5A-MR RCP2.6, medium melt (std)',
}
